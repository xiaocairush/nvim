...
noremap sc :source $MYVIMRC<CR>
noremap ev :e $MYVIMRC<CR>
noremap ec :e $XDG_CONFIG_HOME/nvim/coc-settings.json <CR>
...
" nnoremap <LEADER>p :call Show_documentation()<CR>
nnoremap P :call Show_documentation()<CR>
